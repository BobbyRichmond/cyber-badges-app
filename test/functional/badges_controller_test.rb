...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { description: @badge.description, internet_points: @badge.internet_points, name: @badge.name }
    end
  ...
  test "should update badge" do
    put :update, id: @badge, badge: { description: @badge.description, internet_points: @badge.internet_points, name: @badge.name }
    assert_redirected_to badge_path(assigns(:badge))
  end
